                    ...
                    if (typeof parsed_settings.display_frequency != 'undefined') {
                        if (parsed_settings.display_frequency != '1') {
                            if (getCookie('knowband_spinwheel_frequency') == '1') {
                                ...
                                document.cookie = "knowband_spinwheel_frequency="+parsed_settings.display_frequency+";" + expires + ";path=/";
                            }
                        }
                    }
...
function rotateWheel(event)
{
    ...
    if (!error) {
        ...
        jQuery.ajax({
            ...
            url: urlFrontAjax,
            dataType: "JSON",
            data: {ajax: true, customer_email: cus_email, method: 'checkWinningAndGenerateCoupon'},
            beforeSend: function () {
