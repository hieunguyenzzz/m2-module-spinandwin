...
//                new \Knowband\Spinandwin
    ...
    public function detectDevice()
    {
        ...
        if ($mobile_device->isMobile()) {
            $mobile_class = __("Mobile");
        } elseif ($mobile_device->isTablet()) {
            $mobile_class = __('Tablet');
        } else {
            $mobile_class = __('Desktop');
        }
     ...
     */
    public function checkSlicesAndGenerateCoupon($email = '') 
    {
        ...
        $this->constantContactSubscribeEmailList($email);
        ...
        if ($slice_data[$selected_slice]['coupon_value'] == 0) {
     ...
     */
    public function constantContactSubscribeEmailList($email) {
        $db_settings = $this->getSettings('email_marketing');
